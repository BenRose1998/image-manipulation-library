...
namespace COMP3304Assessment
{
    ...
    class Controller
    {
        ...
        public Controller()
        {
            ...
            _viewer = new ImageViewer(0, ExecuteCommand, RequestImage, _model.FlipImage, _model.SaveImage);
        ...
        public void DisplayImage(int key)
        {
            ...
            if ((_viewer as Form).IsDisposed)
            {
                ...
                _viewer = new ImageViewer(key, ExecuteCommand, RequestImage, _model.FlipImage, _model.SaveImage);
